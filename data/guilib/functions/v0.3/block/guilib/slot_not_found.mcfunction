...
execute if score #Slots guilib.temp matches 0 run function guilib:v0.3/block/guilib/exit/
execute if score #Slots guilib.temp matches 1.. run function guilib:v0.3/block/guilib/loop
