...
execute if score #temp guilib.temp = #exit1 guilib.temp run function guilib:v0.3/block/guilib/exit/found
...
execute if score #exit0 guilib.temp matches 1.. run function guilib:v0.3/block/guilib/exit/loop
