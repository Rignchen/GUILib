## function guilib:v0.5/block/tick
...
execute if entity @s[type=#guilib:v0.5/item_frame] run data modify entity @s Item.tag.guilib set from storage guilib:temp guilib
