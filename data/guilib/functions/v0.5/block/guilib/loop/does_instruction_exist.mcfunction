...
execute if score #temp guilib.slots matches 23 if data storage guilib:temp guilib.Slots[{Slot:23b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/23
execute if score #temp guilib.slots matches 22 if data storage guilib:temp guilib.Slots[{Slot:22b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/22
execute if score #temp guilib.slots matches 21 if data storage guilib:temp guilib.Slots[{Slot:21b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/21
execute if score #temp guilib.slots matches 20 if data storage guilib:temp guilib.Slots[{Slot:20b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/20
execute if score #temp guilib.slots matches 19 if data storage guilib:temp guilib.Slots[{Slot:19b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/19
execute if score #temp guilib.slots matches 18 if data storage guilib:temp guilib.Slots[{Slot:18b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/18
execute if score #temp guilib.slots matches 17 if data storage guilib:temp guilib.Slots[{Slot:17b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/17
execute if score #temp guilib.slots matches 16 if data storage guilib:temp guilib.Slots[{Slot:16b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/16
execute if score #temp guilib.slots matches 15 if data storage guilib:temp guilib.Slots[{Slot:15b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/15
execute if score #temp guilib.slots matches 14 if data storage guilib:temp guilib.Slots[{Slot:14b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/14
execute if score #temp guilib.slots matches 13 if data storage guilib:temp guilib.Slots[{Slot:13b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/13
execute if score #temp guilib.slots matches 12 if data storage guilib:temp guilib.Slots[{Slot:12b}] run function guilib:v0.5/block/guilib/loop/instruction_exist/12
