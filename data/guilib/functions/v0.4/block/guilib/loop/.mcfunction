## function guilib:v0.4/block/guilib/has_instructions
...
tellraw @a[tag=convention.debug] {"score":{"name": "#temp","objective": "guilib.slots"}}
...
execute if score #total guilib.slots matches 1.. run function guilib:v0.4/block/guilib/loop/
