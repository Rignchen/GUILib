...
execute if score #Slots guilib.temp matches 0 run function guilib:v0.1/block/guilib/exit/
execute if score #Slots guilib.temp matches 1.. run function guilib:v0.1/block/guilib/loop
