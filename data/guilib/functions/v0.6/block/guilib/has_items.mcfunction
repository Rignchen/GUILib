## function guilib:v0.6/block/has_changed
...
#find the slot
execute if score #temp guilib.temp matches 0 run function guilib:v0.6/block/guilib/exit/all
execute if score #temp guilib.temp matches 1 run function guilib:v0.6/block/guilib/has_instructions
